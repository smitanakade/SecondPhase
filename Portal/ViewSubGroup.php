...
$query="SELECT smId,smDescription,m.CategorieDescription as MainGroup,s.visible FROM subMainCategory as s INNER JOIN maincategories as m on m.Id = s.mainCatId";
...
while ($row = mysqli_fetch_array($result, MYSQL_BOTH)) {
  ?>
    <tr>
      ...
      <td><a href="EditsubGroup.php?id=<?php echo  $row["smId"]; ?>"><?php echo $row["smDescription"];?></a></td>
