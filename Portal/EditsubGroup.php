...
if(isset($_GET['delete'])){
    //deleting record from the database
        $delete="DELETE FROM subMainCategory WHERE smId=".$_GET['delete'] ;
       mysqli_query($link, $delete) or die(mysql_error());
       header("Location:ViewSubGroup.php");
    }

    if(isset($_POST['Submit'])){

       $query="update subMainCategory set smDescription='".mysqli_real_escape_string($link, $_POST['smDescription'])."',Content='".mysqli_real_escape_string($link,$_POST['Content'])."',mainCatId='".mysqli_real_escape_string($link,$_POST['MainCat'])."',visible='".mysqli_real_escape_string($link, $_POST['visible'])."'  where smId=".$_POST['Id'] ;
...
$pageid = $_GET['id'];
if($pageid){
$query="SELECT smId,smDescription,Content,m.CategorieDescription as MainGroup, m.Id as mainid,s.visible FROM subMainCategory as s INNER JOIN maincategories as m on m.Id = s.mainCatId where smId=".$pageid;
                ...
                <div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="smDescription" id="smDescription" value="<?php echo strtoupper($smDescription);?>" placeholder="Sub Group Name"/>
								</div>
							</div>
                        </div>
                        <div class="form-group">
    ...
    ?>
      <div class="form-group ">
                        <input type="hidden" value="<?php echo $_GET['id'];?>" name="Id">
                            ...
                            <a href="EditsubGroup.php?delete=<?php echo $pageid;?>" class="btn btn-primary btn-lg" style="float: right;" onclick="return confirm('Are you sure you want to delete this item?');" name="Remove" Id="Remove" value="Remove">Remove</a>
						</div>
